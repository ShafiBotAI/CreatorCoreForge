...
PROJECT_DIR = os.path.join('apps', 'CoreForgeBuild', 'BuildApp')
...
{chr(10).join(file_refs)}
        {product} /* CoreForgeBuild.app */ = {{isa = PBXFileReference; explicitFileType = wrapper.application; path = CoreForgeBuild.app; sourceTree = BUILT_PRODUCTS_DIR; }};
...
/* Begin PBXNativeTarget section */
        {target} /* CoreForgeBuild */ = {{
            isa = PBXNativeTarget;
            buildConfigurationList = {target_conf_list} /* Build configuration list for PBXNativeTarget \"CoreForgeBuild\" */;
            buildPhases = (
                {sources_phase},
                {frameworks_phase},
            );
            ...
            productReference = {product} /* CoreForgeBuild.app */;
...
/* Begin XCConfigurationList section */
        {target_conf_list} /* Build configuration list for PBXNativeTarget \"CoreForgeBuild\" */ = {{
...
if __name__ == "__main__":
    ...
    out_path = os.path.join('apps', 'CoreForgeBuild', 'CoreForgeBuild.xcodeproj', 'project.pbxproj')
