...
/// Fetches public domain books from Open Library and downloads their text.
final class KindleService {
    ...
    /// Retrieve a small sample of available books for the given query.
    func fetchAvailableBooks(query: String = "bestseller", completion: @escaping ([KindleBook]) -> Void) {
        ...
        session.dataTask(with: url) { data, _, _ in
            ...
            let books = docs.compactMap { doc -> KindleBook? in
    ...
    /// Download the book text and split it into basic chapters.
